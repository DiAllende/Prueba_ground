"""
Django settings for prueba_ground project.
...
SECRET_KEY = 'django-insecure-0wwsq_7flmzsme9yv5exa-n9zz0&y-s63pi*gz3*7yn3ujjg_0'
...
ROOT_URLCONF = 'prueba_ground.urls'
...
WSGI_APPLICATION = 'prueba_ground.wsgi.application'
